...
| Family Code case annotations | `cases/FAM_CASES.json.gz` | 50 KB | 64 distinct appellate cases / 103 section annotations (DVPA/coercive-control focus) mapped to 39 Family Code sections, 4 CCP sections, and 2 section ranges |
