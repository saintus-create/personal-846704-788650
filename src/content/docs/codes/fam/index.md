...
The complete statutory text of the Family Code, organized by its official divisions.
Use the search bar to locate sections, or [Ask AI](/ask/) a research question.

## Contents

- [Division 1–20](/codes/fam/div-1-div-20/)

## Downloads

- [Download the `FAM.jsonl.gz` dataset](https://github.com/saintus-create/personal-846704-788650/blob/main/public/corpus/law/FAM.jsonl.gz)
