...
import { ArrowRightIcon, BookOpenIcon, Building2Icon, GavelIcon, LandmarkIcon, EllipsisIcon, PanelLeftIcon, PlusIcon, Trash2Icon } from "lucide-react";
    ...
    >
      <div className="flex flex-col gap-1 px-2 pt-2 pb-2">
        <div className="flex items-center justify-between">
          <Link
            className="flex h-8 items-center gap-2 rounded-md px-2 text-sm font-medium text-foreground transition-colors hover:bg-muted/60"
            href="/"
            onClick={() => {
              onNewChat();
              onNavigate?.(null);
          ...
          >
            <span className="truncate">California Legislative Information</span>
          </Link>
          {onToggleSidebar ? (
            <Button
      ...
      <div className="flex flex-col gap-0.5 px-2 pb-2">
        ...
        <Link className="flex h-8 items-center gap-2 rounded-md px-2 text-sm text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground" href="/codes">
          <BookOpenIcon className="size-4" />
          Codes
        </Link>
        <Link className="flex h-8 items-center gap-2 rounded-md px-2 text-sm text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground" href="/bills">
          <LandmarkIcon className="size-4" />
          Bills 2025-26
        </Link>
        <Link className="flex h-8 items-center gap-2 rounded-md px-2 text-sm text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground" href="/rules">
          <GavelIcon className="size-4" />
          Rules of Court
        </Link>
        <Link className="flex h-8 items-center gap-2 rounded-md px-2 text-sm text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground" href="/directory">
