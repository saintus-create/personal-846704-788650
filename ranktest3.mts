...
for (const q of ["domestic abuse definition family code", "family code domestic violence abuse elements", "difference between burglary and robbery", "statute of limitations personal injury"]) {
  const hits = scoreSections([q], records, ["FAM", "PEN", "CCP"], 8);
  console.log("Q:", q);
